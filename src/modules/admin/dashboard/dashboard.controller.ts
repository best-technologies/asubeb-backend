...
export class DashboardController {
  ...
  @ApiQuery({ name: 'session', required: false, description: 'Academic session ID or name' })
  @ApiQuery({ name: 'term', required: false, description: 'Academic term ID or name' })
  ...
  @ApiQuery({ name: 'lgaId', required: false, description: 'Filter by LGA ID' })
